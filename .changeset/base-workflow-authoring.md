...
BaseWorkflow is the sole authoring form; `services/main`; dashboard login; signal/child/subscriber fixes
...
- A child that fails to *start* now surfaces the failure to the parent instead of
