---
'@adonis-agora/durable-core': minor
'@adonis-agora/durable': minor
---

Collapse the `@adonis-agora/durable-transport-queue`, `@adonis-agora/durable-transport-db` and
`@adonis-agora/durable-store-lucid` packages into `@adonis-agora/durable-core` as config-driven drivers. Transports
...
@adonis-agora/durable` command now also publishes the Lucid migrations. The three standalone packages are
removed.
