...
`@agora/durable-testing` runs a whole workflow in a unit test — in-memory store and transport, a clock you control, and assertions that read back the recorded state.

```bash
npm i -D @agora/durable-testing
```
